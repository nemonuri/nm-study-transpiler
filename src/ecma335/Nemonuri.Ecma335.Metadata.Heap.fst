...
let is_indexing_empty (#data_t:Type) {| e : emptyable data_t |} (table:tablelike Te.t data_t) (te:Te.t{table.id_refiner te}) : Tot bool =
...
type string_heap = maplike Ter.string_heap_index_predicate string_data
//table:tablelike Te.t string_data{F.feq table.id_predicate Ter.string_heap_index_predicate}

let is_indexing_empty_string (heap:string_heap) (idx:Ter.string_heap_index) : Tot bool =
  is_indexing_empty (refiner_elem heap) idx
//---|
...
type guid_heap = maplike Ter.guid_heap_index_predicate guid_data
